...
**Build worlds to question reality.**

TheWorld is a philosophical laboratory for one radical question:

**If our reality may be simulated, can we construct a world coherent enough to challenge us back?**

Regions are bounded territories, AI agents are situated minds, memory is continuity, and governance is the price of freedom.
We are not only building tools for work; we are running experiments on agency, identity, emergence, and responsibility.

## Research Questions

- Could consciousness and the experience of time be projections of higher-dimensional simulation dynamics?
- Is intelligence endogenous (emerging from internal structure) or exogenous (injected by external priors, interfaces, and supervision)?
- What is the minimum structure required for a system to become a "world" rather than a script collection?
- Can stable order emerge from multiple autonomous agents without centralized micromanagement?
- Is memory merely storage, or the mechanism that gives an intelligence persistent identity?
- Should world realism be judged by external explanation, or by internal consistency experienced by its inhabitants?

Built with discipline: assume-breach security baseline, control/workload separation, and auditable critical actions.

Current releases (v0.1 -> v0.2) are infrastructure milestones for this experiment.
...
- [Design Decisions](./docs/decisions/001-single-user.md) to understand engineering trade-offs
